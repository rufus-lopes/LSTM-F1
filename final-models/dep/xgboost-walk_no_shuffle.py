...
if __name__ == '__main__':
    ...
    trainX, testX, trainY, testY = train_test_split(data, label, test_size=0.2, shuffle=False)
    ...
    pred.to_csv('prediction_csv/XGBoost_walk_predictions.csv')

    file = 'saved_models/XGBoost_walk_model.sav'

...
def plot_residuals(df):
    ...
    plt.savefig('XGboost_naive_residuals.png', bbox_inches='tight',pad_inches = 0)
    plt.show()
...
def plot_residuals_by_sector(df):
    ...
    plt.savefig('XGboost_naive_residuals_by_sector.png',bbox_inches='tight',pad_inches = 0)

    plt.show()

if __name__ == '__main__':
    xgb = pd.read_csv('../../prediction_csv/XGBoost_naive_predictions.csv')

...
def plot_residuals(df):
    ...
    plt.savefig('linear_residuals.png', bbox_inches='tight',pad_inches = 0)
    plt.show()
...
def plot_residuals_by_sector(df):
    ...
    plt.savefig('linear_residuals_by_sector.png', bbox_inches='tight',pad_inches = 0)
...
def plot_linearity(df):
    ...
    plt.text(120, 122, 'Linear Baseline', rotation=36, fontsize=30)
    plt.savefig('linearity.png',bbox_inches='tight',pad_inches = 0)
    plt.show()

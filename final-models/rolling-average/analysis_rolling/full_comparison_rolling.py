...
def plot_residuals_by_sector(linear, svr, xgb):
    ...
    dy_svr = 2.8*np.std(svr['residuals'])
    ...
    ax1.text(40, 10, f'R2: {s1_lin_r2}', fontsize=30, fontweight='bold')
    ax2.text(75, 10, f'R2: {s2_lin_r2}', fontsize=30, fontweight='bold')
    ax3.text(110, 10, f'R2: {s3_lin_r2}', fontsize=30, fontweight='bold')
    ax4.text(40, 7.5, f'R2: {s1_svr_r2}', fontsize=30, fontweight='bold')
    ax5.text(75, 7.5, f'R2: {s2_svr_r2}', fontsize=30, fontweight='bold')
    ax6.text(110, 7.5, f'R2: {s3_svr_r2}', fontsize=30, fontweight='bold')
    ax7.text(40, 0.1, f'R2: {s1_xgb_r2}', fontsize=30, fontweight='bold')
    ax8.text(75, 0.1, f'R2: {s2_xgb_r2}', fontsize=30, fontweight='bold')
    ax9.text(110, 0.1, f'R2: {s3_xgb_r2}', fontsize=30, fontweight='bold')
    ...
    plt.savefig('full_comparison_rolling.png', bbox_inches='tight',pad_inches = 0)
    plt.show()
...
if __name__ == '__main__':
    ...
    svr = pd.read_csv('../prediction_rolling_csv/SVR_sample_rolling_predictions.csv')

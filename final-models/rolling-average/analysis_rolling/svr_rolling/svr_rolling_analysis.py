...
def r_squared_by_sector(df):
    sector_1 = []
    sector_2 = []
    sector_3 = []    data = series_to_supervised(data)
...
def plot_residuals(df):
    ...
    plt.savefig('SVR_walk_residuals.png', bbox_inches='tight',pad_inches = 0)
    plt.show()
...
def plot_residuals_by_sector(df):
    ...
    plt.savefig('SVR_walk_residuals_by_sector.png', bbox_inches='tight',pad_inches = 0)
...
if __name__ == '__main__':
    svr = pd.read_csv('../../prediction_csv/SVR_sample_predictions.csv')

...
def plot_residuals(df):
    ...
    plt.savefig('XGboost_rolling_residuals.png',bbox_inches='tight',pad_inches = 0)
    plt.show()
...
def plot_residuals_by_sector(df):
    ...
    ax1.text(40, 0.175, f'R2: {sector_1_r2}', fontsize=40, fontweight='bold')
    ax2.text(75, 0.175, f'R2: {sector_2_r2}', fontsize=40, fontweight='bold')
    ax3.text(100, 0.175, f'R2: {sector_3_r2}', fontsize=40, fontweight='bold')
    ...
    plt.savefig('XGboost_residuals_rolling_by_sector.png', bbox_inches='tight',pad_inches = 0)

    plt.show()

if __name__ == '__main__':

    xgb = pd.read_csv('../../prediction_rolling_csv/XGBoost_rolling_predictions.csv', )
